...
import { setTitle } from '@/lib/util'// es6解构写法，把setTitle方法单独引入进来
...
router.beforeEach((to, from, next) => {
  ...
  to.meta && setTitle(to.meta.title)// 首先判断to.meta是否为真（未设置meta的则为假），是的话使用后面的表达式，将to.meta.title传给util.js里的setTitle
